...
fn main() {
    ...
    while window.is_open() && !window.is_key_down(Key::Escape) {
        ...
        while cpu.tsc < TICKS_PER_FRAME {
            ...
            cpu = match rom[pc] {
                0x00 => nop(cpu),
                0x01 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x02 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x03 => inc_bc(cpu),
                0x04 => inc_b(cpu),
                0x05 => dec_b(cpu),
                0x06 => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0x0A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x0B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x0C => inc_c(cpu),
                0x0D => dec_c(cpu),
                0x0E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x0F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x10 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x11 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x12 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x13 => inc_de(cpu),
                0x14 => inc_d(cpu),
                0x15 => dec_d(cpu),
                0x16 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x17 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x18 => jr_r8(cpu, signed(rom[pc+1])),
                0x19 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x1A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x1B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x1C => inc_e(cpu),
                0x1D => dec_e(cpu),
                0x1E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x1F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x20 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x21 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x22 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x23 => inc_hl(cpu),
                0x24 => inc_h(cpu),
                0x25 => dec_h(cpu),
                0x26 => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0x2C => inc_l(cpu),
                0x2D => dec_l(cpu),
                0x2E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x2F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x30 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x31 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x32 => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0x36 => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0x3C => inc_a(cpu),
                0x3D => dec_a(cpu),
                0x3E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x3F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x40 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x41 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x42 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x43 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x44 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x45 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x46 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x47 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x48 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x49 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4C => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4D => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x4F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x50 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x51 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x52 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x53 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x54 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x55 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x56 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x57 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x58 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x59 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5C => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5D => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x5F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x60 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x61 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x62 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x63 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x64 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x65 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x66 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x67 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x68 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x69 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6C => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6D => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x6F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x70 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x71 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x72 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x73 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x74 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x75 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x76 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x77 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x78 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x79 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7A => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7B => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7C => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7D => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7E => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x7F => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x80 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x81 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x82 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x83 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x84 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x85 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x86 => add_HL(cpu, &mem),
                0x87 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x88 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x89 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0x8A => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0xE0 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0xE1 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0xE2 => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0xEA => panic!("unknown instruction 0x{:X}", rom[pc]),
                ...
                0xF0 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0xF1 => panic!("unknown instruction 0x{:X}", rom[pc]),
                0xF2 => panic!("unknown instruction 0x{:X}", rom[pc]),
